...
public class Create extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        id_kode = new javax.swing.JTextField();
        ...
        jLabel13.setText("KODE SMARTPHONE");
        ...
        imgPreviewLabel.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        imgPreviewLabel.setText("VIEW IMAGE");
        imgPreviewLabel.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));

        lbl.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        lbl.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lbl.setText("MODEL");

        id_kode.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                id_kodeActionPerformed(evt);
            }
        });
                            ...
                            .addGroup(jPanel6Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                                ...
                                                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                                    ...
                                                    .addComponent(id_kode, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 500, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    ...
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel6Layout.createSequentialGroup()
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addComponent(id_harga, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 500, javax.swing.GroupLayout.PREFERRED_SIZE)
                                            .addComponent(createBtn, javax.swing.GroupLayout.Alignment.TRAILING)))))))
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(imgPreviewLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 300, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        jPanel6Layout.setVerticalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(imgPreviewLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 350, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(lbl)
                ...
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel13)
                    .addComponent(id_kode, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel14)
    ...
    private void id_kodeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_id_kodeActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_id_kodeActionPerformed

    public boolean checkInput(){
        System.out.println(id_model.getText());
    ...
    private void createBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createBtnActionPerformed
        ...
        if(!status){
            JOptionPane.showMessageDialog(null, "Pastikan semua field terisi!", "Gagal Create", JOptionPane.ERROR_MESSAGE);
        }else{
            if (!id_camPri.getText().matches("[0-9]+")){
                ...
                try {
                    ...
                    if(db.insertSmartphone(id_judul.getText(), id_kode.getText() + "." + ext, id_kode.getText(), id_cpu.getText(), id_gpu.getText(), Integer.parseInt(id_camSec.getText()), Integer.parseInt(id_camPri.getText()), Integer.parseInt(id_internal.getText()), id_status.getText(), id_size.getText(), id_type.getText(), id_res.getText(), id_network.getText(), id_os.getText(), id_chip.getText(), id_card.getText(), id_announce.getText(), id_dimension.getText(), id_weight.getText(), id_sim.getText(), Integer.parseInt(id_harga.getText()), id_merek.getText(), Integer.parseInt(id_version.getText()), id_model.getText())){
                        ...
                        JOptionPane.showMessageDialog(null, "Berhasil menambah smartphone baru!", "Insert Success", JOptionPane.INFORMATION_MESSAGE);
                        new Home().setVisible(true);
                        this.dispose();
                    }else{
                        JOptionPane.showMessageDialog(null, "Gagal menambah smartphone!", "Insert Fail", JOptionPane.ERROR_MESSAGE);
                    }
                } catch (ClassNotFoundException ex) {
                    Logger.getLogger(Create.class.getName()).log(Level.SEVERE, null, ex);
                }
    ...
    private javax.swing.JTextField id_kode;
